...
class Users extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        foreach ($user_data as $k => $v) {
            ...
            $group = $this->Model_employee->getUserGroup($v['id']);
    ...
    public function create()
    {
        ...
        $this->form_validation->set_rules('username', 'Username', 'trim|required|min_length[5]|max_length[12]|is_unique[tbl_users.user_name]');
        $this->form_validation->set_rules('employee', 'Employee', 'trim|required|min_length[1]|max_length[12]|is_unique[tbl_users.user_emp_id]');
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $data = array(
                ...
                'user_emp_id' => $this->input->post('employee'),
                'user_created_by' => $this->session->userdata('username'),
            );
            ...
            $emp_data = $this->Model_employee->getEmployeeData();
            $this->data['group_data'] = $group_data;
            $this->data['emp_data'] = $emp_data;
