	...
	*/
	public function create()
	{
		...
		$this->form_validation->set_rules('attribute_name', 'Attribute name', 'trim|required');
			$this->form_validation->set_rules('attribute_name2', 'Attribute name2', 'trim|required');
			$this->form_validation->set_rules('attribute_name3', 'Attribute name3', 'trim|required');
        ...
        if ($this->form_validation->run() == TRUE) {
        	$data = array(
        		...
        		'name2' => $this->input->post('attribute_name2'),
        		'name3' => $this->input->post('attribute_name3'),
	...
	public function update($id)
	{
		...
		if($id) {
			$this->form_validation->set_rules('edit_attribute_name', 'Attribute name', 'trim|required');
				$this->form_validation->set_rules('edit_attribute_name2', 'Attribute name2', 'trim|required');
				$this->form_validation->set_rules('edit_attribute_name3', 'Attribute name3', 'trim|required');
	        ...
	        if ($this->form_validation->run() == TRUE) {
	        	$data = array(
	        		...
	        		'name2' => $this->input->post('edit_attribute_name2'),
	        		'name3' => $this->input->post('edit_attribute_name3'),
