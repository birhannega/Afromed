    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createitem', $user_permission)): ?>
          <a href="<?php echo base_url('entries/create') ?>" class="btn btn-primary">New Entry</a>
          <br /> <br />
        <?php endif; ?>
        ...
        <div class="box">
          ...
          <!-- /.box-header -->
          <div class="box-body">
            <table id="manageTable" class="table table-bordered table-condensed table-striped">
              <thead>
              <tr>
                  <th>Date </th>
                  <th>item </th>
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'entries/fetchEntryData',
    'order': []
  });
