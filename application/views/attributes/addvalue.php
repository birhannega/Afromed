...
<div class="content-wrapper">
  ...
  <section style="color:blue" class="content-header">
    <h1>
      Manage Attributes
      <small>Value</small>
    </h1>
  ...
  <!-- Main content -->
  <section style="color:blue" class="content">
        ...
        <div class="box">
          <div class="box-body">
            <h4>Attribute name: <?php echo $attribute_data['name']; ?></h4>
               <h4>Attribute name2: <?php echo $attribute_data['name2']; ?></h4>
                  <h4>Attribute name3: <?php echo $attribute_data['name3']; ?></h4>
          </div>
        </div>
...
//dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd
      ...
      $("#edit_attribute_value_name2").val(response.value2);
      $("#edit_attribute_value_name3").val(response.value3);
